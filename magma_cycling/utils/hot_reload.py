...
Examples:
    Add at the start of your script::
        ...
        from magma_cycling.utils.hot_reload import hot_reload_if_needed
    ...
    Or use as decorator::
        ...
        from magma_cycling.utils.hot_reload import with_hot_reload
...
def hot_reload_if_needed(package_name: str = "magma_cycling", verbose: bool = False) -> list[str]:
    """
...
def mark_modules_loaded(package_name: str = "magma_cycling") -> None:
    """

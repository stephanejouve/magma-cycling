...
Usage:
    ...
    python3 magma_cycling/organize_weekly_report.py --week 067

    # Depuis répertoire temporaire
    python3 magma_cycling/organize_weekly_report.py --week 067 --from-dir /tmp/bilans_s067

    # Mode dry-run (test sans écriture)
    python3 magma_cycling/organize_weekly_report.py --week 067 --dry-run.
"""
import argparse
import re
import subprocess

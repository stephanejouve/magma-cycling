...
Metadata:
    ...
    Replacement: magma_cycling.workflows.workflow_weekly

Migration vers le nouveau système (Phase 2 - Weekly Analysis System):
    Ancien (deprecated):
        python3 magma_cycling/weekly_analysis.py --week-id S073
...
Documentation:
    magma_cycling/workflows/workflow_weekly.py
    magma_cycling/analyzers/weekly_aggregator.py
    magma_cycling/analyzers/weekly_analyzer.py
...
"""
    ...
    def run(self):
        ...
        print()
        print("Documentation: magma_cycling/workflows/workflow_weekly.py")
        print("=" * 70)
        print()

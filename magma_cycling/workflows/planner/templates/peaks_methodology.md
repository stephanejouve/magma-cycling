...
1. **Semaine ACTUELLE ({week_number})**:
...
```
=== WORKOUT {week_number}-01-TYPE-NomExercice-V001 ===
...
```markdown
### WORKOUT: {week_number}-0X-TYPE-NomExercice-V001
...
```
=== WORKOUT {week_number}-01-END-EnduranceBase-V001 ===
...
=== WORKOUT {week_number}-02-INT-SweetSpot-V001 ===
...
Génère les 7 entraînements pour {week_number} ({date_start_str} → {date_end_str}) au format ci-dessus.

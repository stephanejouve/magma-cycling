...
Usage:
    # Validation complète
    python3 magma_cycling/validate_naming_convention.py

    # Mode verbeux (affiche tous les fichiers)
    python3 magma_cycling/validate_naming_convention.py --verbose

    # JSON output (pour intégration CI)
    python3 magma_cycling/validate_naming_convention.py --json

...
from magma_cycling.reports.ai_client import AIClientError
...
# Run with coverage
pytest tests/reports/ --cov=magma_cycling/reports --cov-report=term-missing
...
```python
from magma_cycling.reports.templates.base import ReportTemplate
...
```python
from magma_cycling.reports.prompts.new_report_prompt import build_new_report_prompt
...
Part of magma-cycling project. All rights reserved.

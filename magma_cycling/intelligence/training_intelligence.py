...
class TrainingIntelligence:
    ...
    def get_discrete_pid_correction(
        ...
        Calcule gains PID adaptatifs depuis intelligence accumulée,
        puis compute correction TSS recommandée niveau cycle.

        Architecture:
            - Appelé UNIQUEMENT lors test FTP validé (tous les 6-8 semaines)
            - Correction appliquée sur cycle complet (sample-and-hold)
            - Gains conservateurs adaptés système lent
        ...
        Example:
            ...
            8  # Appliqué sur cycle suivant S007-S012
            >>> print(result["recommendation"])
            Augmenter TSS +8/semaine - Progression modérée. Appliquer sur cycle complet (6 semaines).
        """

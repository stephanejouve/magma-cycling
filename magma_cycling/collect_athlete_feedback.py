...
Usage:
    python3 magma_cycling/collect_athlete_feedback.py
    python3 magma_cycling/collect_athlete_feedback.py --quick  # Mode rapide (RPE + ressenti uniquement)
    python3 magma_cycling/collect_athlete_feedback.py --clear  # Effacer le feedback en attente.
"""
import argparse
import json
import sys
...
def main():
    ...
    try:
        ...
        if collector.prompt_yes_no("\n💾 Sauvegarder ce feedback ?", default=True):
            ...
            print()
            print("   ./magma_cycling/prepare_analysis.py")
        else:

...
from magma_cycling.analyzers.weekly.analysis import AnalysisMixin
from magma_cycling.analyzers.weekly.data import DataMixin
from magma_cycling.analyzers.weekly.processing import ProcessingMixin
...
class WeeklyAggregator(DataMixin, ProcessingMixin, AnalysisMixin, DataAggregator):
    """

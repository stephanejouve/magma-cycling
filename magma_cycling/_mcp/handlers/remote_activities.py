    ...
    try:
        with suppress_stdout_stderr():
            ...
            result = {
                ...
                # rpe is exposed as icu_rpe in the Intervals.icu API (the plain
                # ``rpe`` key does not exist on activity payloads). BT-013 v1
                # mapped it to ``rpe`` directly which always returned null.

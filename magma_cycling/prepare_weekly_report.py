...
Usage:
    python3 magma_cycling/prepare_weekly_report.py --week 067
    python3 magma_cycling/prepare_weekly_report.py --week 067 --start-date 2025-11-11.
"""
import argparse
import re
import subprocess
...
def main():
    ...
    print(f"   python3 magma_cycling/organize_weekly_report.py --week {week_number}")
    print()
    print("=" * 60)

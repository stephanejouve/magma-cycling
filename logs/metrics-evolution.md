...
|------|------------|------|----------|---------|
| _JJ/MM/AAAA_ | 220 | 2.62 | Baseline initiale | _Test 20min/Estimation_ |

### Notes FTP
- Baseline actuelle : **220W**
- Objectif à terme : **260W+**
- Tests planifiés : _[dates et protocoles]_
...
|------|------------|-------|------|
| _JJ/MM/AAAA_ | 83.8 | Matin | Post-réveil, avant petit-déjeuner |

### Tendance
- Baseline : **83.8kg**
- Plage cible : _[selon objectifs]_
- Variations saisonnières observées : _[patterns]_
...
|------|-------|---------|----------|------|
| _JJ/MM/AAAA_ | 5h33 | _XX%_ | 40 bpm | Dette sommeil |
...
|--------|------|------------|------------|
| _SXXX-XX-..._ | _Type_ | _X.X%_ | ✅ <7.5% |

**Seuil Validation** : **<7.5%** systématiquement

---

_Mettre à jour ce fichier régulièrement avec les nouvelles données_

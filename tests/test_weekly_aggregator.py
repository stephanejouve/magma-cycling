...
def sample_week_data():
    ...
    return {"week": "S073", "start_date": date(2025, 1, 6)}


def test_weekly_aggregator_initialization(sample_week_data):
    """Test initialisation WeeklyAggregator."""
    aggregator = WeeklyAggregator(
        week=sample_week_data["week"], start_date=sample_week_data["start_date"]
    )
...
def test_process_workouts_detailed():
    ...
    feedback = {"i123": {"rpe": 6, "comments": "Good session"}}
...
def test_identify_protocol_changes():
    ...
    learnings = []
    metrics_evolution = {"trends": {"tsb_change": -12.5}}
...
def test_prepare_transition_data():
    ...
    summary = {"total_tss": 320, "avg_tss": 45.7, "final_metrics": {"tsb": -18.5}}

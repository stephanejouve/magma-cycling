...
class TestAIProvidersConfig:
    ...
    def test_get_provider_config_mistral(self):
        ...
        with patch.dict(os.environ, {'MISTRAL_API_KEY': 'test-key', 'MISTRAL_MODEL': 'mistral-large'}):
            config = AIProvidersConfig()
    ...
    def test_get_provider_config_ollama(self):
        ...
        with patch.dict(os.environ, {'OLLAMA_BASE_URL': 'http://localhost:11434', 'OLLAMA_MODEL': 'mistral:7b'}):
            config = AIProvidersConfig()
    ...
    def test_get_fallback_chain_with_fallback_disabled(self):
        ...
        with patch.dict(os.environ, {'ENABLE_AI_FALLBACK': 'false', 'DEFAULT_AI_PROVIDER': 'clipboard'}):
            config = AIProvidersConfig()

...
Usage:
    python3 scripts/normalize_weekly_reports_casing.py [--dry-run] [--force]
"""
    ...
    def run(self):
        ...
        if self.changes and not self.dry_run:
            ...
            if backup_dirs:
                ...
                print(f"      rm -rf logs/weekly_reports")
...
def main():
    ...
    parser.add_argument(
        '--force',
        action='store_true',
        help="Forcer le renommage même si la cible existe"
    )

    ...
    try:
        ...
        if activities:
            ...
            try:
                ...
                critical_fields = [
                    'moving_time', 'elapsed_time', 'duration',
                    'icu_training_load', 'training_load', 'tss',
                    'icu_average_watts', 'average_watts', 'avg_watts', 'power',
                    'icu_intensity', 'intensity', 'if',
                    'icu_weighted_avg_watts', 'weighted_avg_watts', 'np'
                ]

...
Usage:
    ...
    python3 scripts/insert_analysis.py --dry-run  # Test sans modification
    python3 scripts/insert_analysis.py --file analysis.md  # Depuis fichier
"""
...
class AnalysisParser:
    ...
    def validate_analysis(text):
        """Valider que le texte est bien une analyse formatée"""

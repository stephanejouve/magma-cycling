...
Usage:
    ...
    python3 scripts/fix_weekly_reports_casing.py --dry-run

    # Exécution réelle (demande confirmation)
    python3 scripts/fix_weekly_reports_casing.py

    # Force (sans confirmation - DANGEREUX)
    python3 scripts/fix_weekly_reports_casing.py --force

    # Rollback (restaurer backup)
    python3 scripts/fix_weekly_reports_casing.py --rollback
"""

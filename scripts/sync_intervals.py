...
Usage:
    python3 scripts/sync_intervals.py --athlete-id XXXXXX --api-key YOUR_KEY
    python3 scripts/sync_intervals.py --config ~/.intervals_config.json
    python3 scripts/sync_intervals.py --last-days 7

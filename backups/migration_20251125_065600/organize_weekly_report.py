...
Usage:
    ...
    python3 scripts/organize_weekly_report.py --week 067

    # Depuis répertoire temporaire
    python3 scripts/organize_weekly_report.py --week 067 --from-dir /tmp/bilans_s067

    # Mode dry-run (test sans écriture)
    python3 scripts/organize_weekly_report.py --week 067 --dry-run
"""
